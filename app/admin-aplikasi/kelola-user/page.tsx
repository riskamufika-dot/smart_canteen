  ...
  return (
    <div className="relative min-h-screen bg-slate-100 p-8 text-slate-800">
      <div className="mx-auto max-w-4xl rounded-3xl bg-white p-8 shadow-xl">
        ...
        {/* Header (Tanpa tombol Tambah Pengguna) */}
                ...
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  {dataPengguna.map((user) => (
                    <tr key={user.id} className="transition-colors hover:bg-slate-50/50">
                      <td className="px-6 py-3 font-semibold text-slate-900">{user.username}</td>
          ...
          <div className="w-full max-w-lg rounded-3xl bg-white p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-sm font-bold text-slate-900">Nama Pengguna</label>
                <input
                  type="text"
