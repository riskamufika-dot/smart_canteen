'use client'; // Pastikan ada directive ini di paling atas jika menggunakan Next.js App Router
...
export default function Dashboard() {
  ...
  // 2. Fetch data pengguna dari API Strapi saat komponen dimuat
  useEffect(() => {
    const fetchTotalUsers = async () => {
      try {
        ...
        // Menghitung jumlah array user dari Strapi
        ...
        <aside className="flex w-64 flex-col justify-between border-r border-slate-100 p-6">
          ...
          <span className="text-orange-500">Smart</span> Canteen
            ...
            <nav className="flex flex-col gap-3">
              <button className="flex w-full items-center justify-center rounded-full border border-orange-200 bg-orange-50 py-2.5 font-semibold text-orange-500 shadow-sm transition-colors hover:bg-orange-100">
                Dashboard
              </button>
            <Link 
          ...
          {/* Logout Button */}
          <button className="flex items-center gap-3 font-semibold text-slate-700 hover:text-red-500 transition-colors px-2">
            ...
            <div className="rounded-2xl border border-slate-200 p-4">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 rounded-lg border border-slate-100 p-2">
                  <div className="h-10 w-12 rounded bg-slate-300"></div>
                  <div>
